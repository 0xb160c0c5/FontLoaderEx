...
constexpr DWORD SPS_NOCAPTURE = 0b100u;	// Do not capture the cursor while dragging;

typedef struct tagSPLITTER	// lParam in WM_NOTIFY
{
	NMHDR hdr;
	POINT ptCursor;	// Cursor position relatives to parent window client
	LONG CursorOffset;	// Cursor offset relatives to splitter top/left
